...
insert into orders (id, order_number, username,
                    ...
                    status, comments)
values (1, 'order-123', 'azdanov',
        'Anton', 'anton@example.com', '11111111',
        '123 Main St', 'Apt 1', 'Hamburg', 'DE', '75001', 'Germany',
        'NEW', null),
       (2, 'order-456', 'azdanov',
        'Ždanov', 'azdanov@example.com', '2222222',
        '123 Main St', 'Apt 1', 'Tallinn', 'HA', '500072', 'Estonia',
        'NEW', null);

insert into order_items(order_id, code, name, price, quantity)
values (1, 'P100', 'The Hunger Games', 34.0, 2),
