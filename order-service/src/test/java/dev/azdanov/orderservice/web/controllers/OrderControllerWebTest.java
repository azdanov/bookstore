...
import static dev.azdanov.orderservice.testdata.TestDataFactory.createOrderRequestWithInvalidDeliveryAddress;
import static dev.azdanov.orderservice.testdata.TestDataFactory.createOrderRequestWithNoItems;
...
class OrderControllerWebTest {
    ...
    public static final String USERNAME = "azdanov";
    ...
    @BeforeEach
    void setUp() {
        given(securityService.getLoginUserName()).willReturn(Optional.of(USERNAME));
    }
    ...
    void shouldReturnBadRequestWhenOrderPayloadIsInvalid(CreateOrderRequest request) throws Exception {
        given(orderService.createOrder(eq(USERNAME), any(CreateOrderRequest.class)))
                .willReturn(null);
